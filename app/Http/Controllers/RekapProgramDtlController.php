...
class RekapProgramDtlController extends Controller
{
    public function index(Request $req)
    {
        $app['judul']   = "Rekap Keuangan Berdasarkan Program [Detail]";
        $app['program'] = MGM::getRfProgram(false,false);
        return view('pages.rekap_program.rekapkeuanganprogramdtl', $app);
    }
    ...
    public function get(Request $req)
    {
        ...
        $q = "select kd_kategori, nm_kategori,kd_program, nm_program, "
