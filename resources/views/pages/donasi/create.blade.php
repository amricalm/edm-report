            ...
            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-9">
                                                            @if($ModeEdit=='TAMBAH')                                                              
                                                                @if($linkId!='')
                                                                    <select name="KdAgen" id="KdAgen" class="form-select form-control form-control-sm  mb-1   huruf-kecil" data-val="true" data-val-required="Harus Diisi" tabindex="2">
                                                ...
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-9">
                                                                @if($ModeEdit=='TAMBAH')
                                                                    @if($linkId!='')
                                                                        <select name="KdSales" id="KdSales" class="form-select form-control form-control-sm  mb-1   huruf-kecil" data-val="true" data-val-required="Harus Diisi" tabindex="3">
                                            ...
                                            <div class="form-group row row-sm mb-1">
                                                <div class="col-lg-4 col-md-12">
                                                    ...
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input {{$nonAktif}} type="text" value="{{$donasi->no_kwitansi}}" name="NoKwitansi" id="NoKwitansi" class="form-control  form-control-sm  mb-1   huruf-kecil" data-val="true" data-val-required="Harus Diisi" autocomplete="off" tabindex="4">
                                                        </div>
                                                        
                                                        <div class="col-md-2">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="" {{$nonAktif}}  id="chk-auto"  tabindex="5">
                                                                <label class="form-check-label fs-11 fw-bold" for="flexCheckChecked">
                                                                Auto
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                {{-- <div class="col-lg-1 col-md-12 px-0"> --}}
                                                        ...
                                                        {{-- <label class="col-md-12 fs-11 fw-bold px-1 custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" {{$nonAktif}} id="chk-auto" name="auto" tabindex="5">
                                                            <span class="custom-control-label"></span><span class="ms-5">Auto</span>
                                                        </label> --}}
                                                        
                                                {{-- </div> --}}
                                                <div class="col-lg-2 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        <label class="col-md-6 fs-11 text-right fw-bold">Tgl. Transaksi</label>
                                                        <div class="col-md-6">
                                                            <input type="text" value="{{$donasi->tgl_transaksi}}" name="Tgl" id="tgl" class="form-control form-control-sm mb-1   huruf-kecil" data-val-date="The field Tgl. Transaksi must be a date." data-val-required="Harus Diisi" autocomplete="off" tabindex="6">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-2 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        <label class="col-md-6 fs-11 text-right fw-bold">Tgl. Setor</label>
                                                        <div class="col-md-6">
                                                            <input type="text" value="{{$donasi->tgl}}" id="tgl-setor" name="TglSetor" class="form-control form-control-sm mb-1   huruf-kecil" data-val-date="The field Tgl. Setor must be a date." data-val-required="Harus Diisi" autocomplete="off" tabindex="7">
                                                        </div>
                                                    </div>            
                                                </div>
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="KdKas" id="KdKas" class="form-select form-control form-control-sm mb-1   huruf-kecil" data-val="true" data-val-required="Harus Diisi" tabindex="8">
                                                                @foreach($kas as $item){
                ...
                <div class="card bg-light mb-0">
                    <div class="row row-sm">
                        <!-- TABEL TRANSAKSI DIV -->
                        <div class="card">
                            <div class="col-lg-12 col-md-12 container py-2 px-2 mx-2 mw-100" id = "trn-tbl">
                                <div id = "trn-head">
                                ...
                                <div id = "trn-footer">
                                    ...
                                    <div class="row" id = "trn-footer2-row">
                                        ...
                                        <div class="col-lg-2 col-md-12 text-right border huruf-kecil text-right fw-bold py-1 px-1">
                                            <input id="biaya-bank" value="{{number_format($donasi->biaya_bank,0,',','.')  }}" class="form-control input-sm text-right huruf-kecil" type="text" tabindex="50">
                                        </div>
                                        <div class="col-lg-1 col-md-12 border">
...
@section('footer')
    <script type="text/javascript">
        ...
        var projectArr = <?php echo json_encode(App\MGM::getProjectByProgram())?>;
        var filteredProject = projectArr;
        ...
        $(document).ready(function () {
            ...
            $(document).delegate(".cbo-program","change",function(){
                ...
                filteredProject = projectArr.filter(function(itm){
                    return itm.kd_program == prg;
                });

                let baris = this.parentElement.parentElement;
                let kolomProject = baris.getElementsByClassName('kolom-project')[0];
                
                kolomProject.innerHTML = setProject(filteredProject);
        ...
        function setBarisAktif(baris) {
            ...
            let prg = elNilai.innerText;

            let kolomProject = baris.getElementsByClassName('kolom-project')[0];
            elNilai = kolomProject.getElementsByTagName('input')[0];
            let prj = "";
            if(elNilai.value.trim()=="")
            {prj=" ";}else{prj=elNilai.value;}
            let elTeks = kolomProject.getElementsByTagName('span')[0];

            filteredProject = projectArr.filter(function(item){
                    return item.kd_program == prg;
            });
            
            kolomProject.innerHTML = setProject(filteredProject) + '<input type="hidden" class="kd-prj" ori-text="'+elTeks.innerText+'"  ori-value="' + elNilai.value + '" name="kd-prj[]" value="' +elNilai.value + '"/>';
            $('.cbo-prj').select2({placeholder:"Pilih Project",dropdownCssClass: "huruf-kecil"});
            $('.cbo-prj').val(prj);
            $('.cbo-prj').trigger('change');
    ...
    <script>
        ...
        function setProject(argProjects)
        {
            ...
            var ori = $(".kd-prj").attr("ori-value");
            argProjects.forEach((item) => {
                str += "<option value=\"" + item.kd_project + "\">" + item.nm_project + "</option>";
            });
