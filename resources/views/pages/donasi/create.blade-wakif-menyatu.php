                                            ...
                                            <div class="form-group row row-sm mb-1">
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <input type="hidden" id="kd-pelanggan" value="" />
                                                ...
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" value="{{$donasi->donatur->pos}}" name="Pos" id="Pos" class="form-control form-control-sm mb-1  huruf-kecil" autocomplete="off" tabindex="28">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row row-sm mb-0 align-items-center">
                            ...
                            <div class="container py-2 px-2 mx-2 mw-100" id = "trn-tbl">
                                <div class="row" id = "trn-head">
                                    <div class="row" id = "trn-head-row">
                                        <div class="col-lg-2 border huruf-kecil text-center fw-bold py-1">
                                            Program
                                        </div>
                                ...
                                <div class="row" id = "trn-body">
                                    ...
                                    @foreach ($donasi->items as $item)
                                        ...
                                        <div class="row trn-body-row" id="trn-body-row">
                                            <div class="col-lg-2 kolom-program border  py-1 px-1"><span class="huruf-kecil">{{$item->kd_program}}</span><input type="hidden" class="kd-prg" name="program-id[]" value="{{$item->kd_program}}"></div>
                                            ...
                                            <div class="col-lg-2 col-md-12 kolom-qty border py-1 px-1 text-right"><span class="huruf-kecil px-2">{{number_format($item->qty,0,',','.')}}</span></div>
                                            <div class="col-lg-2 col-md-12 kolom-dana border py-1 px-1 text-right"><span class="huruf-kecil px-2">{{number_format($dana,0,',','.')}}</span></div>
                                            <div class="col-lg-2 col-md-12 kolom-jmh border huruf-kecil text-right py-1 px-2" style="display:table-cell; vertical-align:middle"><span class="huruf-kecil px-2">{{number_format($item->jmh,0,',','.')}}</span></div>
                                    ...
                                    <div class="row trn-body-row entri" id = "trn-body-row">
                                        <div class="col-lg-2 kolom-program border  py-1 px-1">
                                        ...
                                        <div class="col-lg-2 col-md-12 kolom-qty border py-1 px-1">
                                            <input id="entri-qty" value="1" class="form-control input-sm text-right huruf-kecil entri-qty" type="text" tabindex="36" disabled='disabled'>
                                        </div>
                                        <div class="col-lg-2 col-md-12 kolom-dana border py-1 px-1">
                                            <input id="entri-dana" class="form-control input-sm angka text-right entri-dana huruf-kecil" type="text" tabindex="37" disabled='disabled'>
                                        </div>
                                        <div class="col-lg-2 col-md-12 kolom-jmh border huruf-kecil text-right py-1 px-2 " style="display:table-cell; vertical-align:middle">
                                ...
                                <div class="row" id = "trn-footer">
                                    <div class="row" id = "trn-footer-row">
                                        ...
                                        <div class="col-lg-3 border huruf-kecil text-right fw-bold py-1">
                                            TOTAL TRANSFER
                                        </div>
                                        <div class="col-lg-2 col-md-12 text-right border huruf-kecil text-right fw-bold py-1">
                                    ...
                                    <div class="row" id = "trn-footer2-row">
                                        <div class="col-lg-9 col-md-12 text-right border huruf-kecil text-right fw-bold py-1">
                                            Biaya Bank
                                        </div>
...
@section('footer')
    <script type="text/javascript">
        ...
        //var $elTrnBodyRow,strTrnBodyRow='';
        var strTrnBodyRow = '';
        ...
        function setBarisAktif(baris) {
            ...
            let kolom = baris.getElementsByClassName('kolom-qty')[0];
    ...
    <script>
        ...
        function SimpanDonasi()
        {
            ...
            // var donasi = {}, hdr = {}, dtl = {}, donatur = {};
            // hdr.modeEdit = 'Edit';
            // hdr.alurKerja = $('#AlurKerja').val();
            // hdr.donasiID = $('#tr-id').val();
            // hdr.idBukuBank = $('#link-idbukubank').val();
            // hdr.noKwitansi = $('#NoKwitansi').val();
            // hdr.kdKas = $('#KdKas').val();
            // hdr.kdAgen = $('#KdAgen').val();
            // hdr.kdSales = $('#KdSales').val();
            // hdr.kdCabang = $('#KdCabang').val();
            // hdr.tgl = $('#tgl').val(); 
            // hdr.tglSetor = $('#tgl-setor').val();
            // hdr.sah = $('#sah').is(":checked");
            // hdr.biayaBank =  $('#biaya-bank').val();
            
            // hdr.nmWakif= $('#NmWakif').val();
            
            // donasi.hdr = hdr;

            // donatur.pelangganID = $('#pelanggan-id').val();
            // donatur.kdPelanggan =$('#kd-pelanggan').val() ;
            // donatur.nmDonatur= $('#NmDonatur').val();
            // donatur.alamat= $('#Alamat').val();
            // donatur.kota= $('#Kota').val();
            // donatur.pos= $('#Pos').val();
            // donatur.propinsi= $('#Propinsi').val();
            // donatur.telp= $('#Telp').val();
            // donatur.ket= $('#Keterangan').val();
            // donatur.hp= $('#Hp').val();
            // donatur.email= $('#Email').val();
                ...
                success: function (respon) {
                    if($.isEmptyObject(respon.error)) {
                        ...
                        const o = {ModeEdit:modeEdit , AlurKerja:alurKerja, DonasiID:donasiID, NoKwitansi:noKwitansi, IdBukuBank:idBukuBank
                                ...
                                , TglSetor:tglSetor,  Ket:ket,  BiayaBank:biayaBank, NmWakif:nmWakif};
                        ...
                        for (i = 0; i < baris.length - 1; i++)
                        {
                            ...
                            kdProject       = kolomPrj.getElementsByTagName('input')[0].value;
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: {donasi : o},//JSON.stringify(o),
                            //dataType: "json",
