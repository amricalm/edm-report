                        ...
                        <div class="card mb-4">
                            <div class="card-body py-4">
                                <div class="form-group row row-sm mb-0">
                                    <label class="col-auto text-right col-form-label-sm">Pembayaran</label>
                                    <div class="col-md-2">
                                    ...
                                    <label class="col-auto text-right col-form-label-sm">Periode</label>
                                    <div class="col-md-2">
                                    ...
                                    <label class="col-auto text-right col-form-label-sm">s/d</label>
                                    <div class="col-md-2">
                                    ...
                                    <label class="col-auto text-right col-form-label-sm">Status</label>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row row-sm mb-0">
                                    <label class="col-auto text-right col-form-label-sm">Kantor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <div class="col-md-2">
                                    ...
                                    <label class="col-auto text-right col-form-label-sm">Kwitansi</label>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" id="tampil" class="btn btn-sm btn-primary float-right" tabindex="9"><i class="fe fe-search"></i>Tampil</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive" id="tbl">
                                    ...
                                    <div class="table-responsive-sm" id="tbl">
                                        <table class="table table-bordered table-striped card-table table-vcenter text-wrap" width="100%">
                                            <thead>
                                              <tr class="border-top">
                                                <th class="py-2">Konfirmasi</th>
                                                <th class="py-2">Tgl Setor</th>
                                                <th class="py-2">Tgl Trs</th>
                                                <th class="py-2">Tgl Input</th>
                                                <th class="py-2">NoKwitansi</th>
                                                <th class="py-2">Kd.Jurnal</th>
                                                <th class="py-2">Nama Wakif</th>
                                                <th class="py-2">Pendaftar</th>
                                                <th class="py-2">Alamat</th>
                                                <th class="py-2">Hp</th>
                                                <th class="py-2">Email</th>
                                                <th class="py-2">Dana</th>
                                                <th class="py-2"></th>
                                              </tr>
                                            </thead>
                                            <tbody id='tbl-body'>
                                                <tr role="row" class="odd">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-06-19</td>
                                                    <td>2021-08-30 09:48</td>
                                                    <td>MID_MDR_web_39172</td>
                                                    <td>RV2006013923</td>
                                                    <td>Zulkhairi Heri</td>
                                                    <td>Zulkhairi Heri</td>
                                                    <td>Apartemen gateway Pesanggrahan Tower B Lt 16 No.17 Petukangan Selatan pesanggrahan</td>
                                                    <td>085658289185</td>
                                                    <td>zulkhairi.heri@gmail.com</td>
                                                    <td class="angka">11.650</td>
                                                    <td>
                                                        <a href="#" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="even">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-13</td>
                                                    <td>2020-11-13 09:18</td>
                                                    <td>MID_GOP_web_45705</td>
                                                    <td>RV2101027406</td>
                                                    <td>Zulkhairi Heri</td>
                                                    <td>Zulkhairi Heri</td>
                                                    <td>Apartemen gateway Pesanggrahan Tower B Lt 16 No.17 Petukangan Selatan pesanggrahan</td>
                                                    <td>085658289185</td>
                                                    <td>zulkhairi.heri@gmail.com</td>
                                                    <td class="angka">11.156</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-13</td>
                                                    <td>2021-02-15 23:32</td>
                                                    <td>MID_GOP_web_45786</td>
                                                    <td>RV2101026799</td>
                                                    <td>Rinda Ayu Nurani</td>
                                                    <td>Rinda Ayu Nurani</td>
                                                    <td></td>
                                                    <td>081326099393</td>
                                                    <td>ndapandarinda@gmail.com</td>
                                                    <td class="angka">11.732</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="even">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-14</td>
                                                    <td>2020-11-18 10:41</td>
                                                    <td>MID_GOP_web_45811</td>
                                                    <td>RV2101027407</td>
                                                    <td>Yusuf</td>
                                                    <td>Yusuf</td>
                                                    <td></td>
                                                    <td>081318765056</td>
                                                    <td>yusuf.seto.pradana5@gmail.com</td>
                                                    <td class="angka">110.243</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-15</td>
                                                    <td>2021-02-24 16:33</td>
                                                    <td>MID_GOP_web_45819</td>
                                                    <td>RV2101026942</td>
                                                    <td>Enda</td>
                                                    <td>Enda</td>
                                                    <td></td>
                                                    <td>081272561974</td>
                                                    <td>enda1615@gmail.com</td>
                                                    <td class="angka">11.750</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="even">
                                                    <td></td>
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-16</td>
                                                    <td>2021-02-24 15:09</td>
                                                    <td>MID_GOP_web_45844</td>
                                                    <td>RV2101026789</td>
                                                    <td>M Firman Karim,H.</td>
                                                    <td>M Firman Karim, H.</td>
                                                    <td></td>
                                                    <td>08888146799</td>
                                                    <td>firmanul2016@yahoo.co.id</td>
                                                    <td class="angka">115.275</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-16</td>
                                                    <td>2021-02-24 15:49</td>
                                                    <td>MID_GOP_web_45860</td>
                                                    <td>RV2101026800</td>
                                                    <td>Heru Binawan</td>
                                                    <td>Heru Binawan</td>
                                                    <td>Jl. Krukut Raya, Perum Pelangi Matoa No A3, Krukut, Limo</td>
                                                    <td>08128003779</td>
                                                    <td>herubinawan65@gmail.com</td>
                                                    <td class="angka">11.660</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr role="row" class="even">
                                                    ...
                                                    <td>2021-01-22</td>
                                                    <td class="sorting_1">2020-11-16</td>
                                                    <td>2021-02-15 23:31</td>
                                                    <td>MID_GOP_web_45870</td>
                                                    <td>RV2101026801</td>
                                                    <td>Indri</td>
                                                    <td>Indri</td>
                                                    <td></td>
                                                    <td>081297997752</td>
                                                    <td>indriana.d@sbm-itb.ac.id</td>
                                                    <td class="angka">120.170</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-id="MID_MDR_web_39172" class="createNew"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
