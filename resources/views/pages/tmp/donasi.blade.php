                        ...
                        <div class="card mb-4">
                            <div class="card-body py-4">
                                <div class="form-group row row-sm mb-0 align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <select name="" id="" class="form-select form-control form-control-sm  mb-2" tabindex="1">
                                            ...
                                            <option value="" selected="">BNI 0555000009</option>
                                        </select>
                                    </div>
                                    <label class="col-auto text-right fs-11">Periode</label>
                                    <div class="col-md-2">
                                        <input type="text" id="tx-tgl-dr" placeholder="yyyy-mm-dd" autocomplete="off" name="" class="form-control  form-control-sm  mb-2" tabindex="2">
                                    </div>
                                    <label class="col-auto text-right fs-11">s/d</label>
                                    <div class="col-md-2">
                                        <input type="text" id="tx-tgl-sd"  placeholder="yyyy-mm-dd" autocomplete="off" name="" class="form-control  form-control-sm  mb-2" tabindex="3">
                                    </div>
                                    <label class="col-auto text-right fs-11">Status</label>
                                    <div class="col-md-2">
                                        <select name="" id="" class="form-select form-control  form-control-sm  mb-2" tabindex="4">
                                            <option value="">-- SEMUA --</option>
                                ...
                                <div class="form-group row row-sm mb-0 align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <select name="" id="" class="form-select form-control  form-control-sm  mb-2" tabindex="5">
                                            <option value=""></option>
                                            <option value="" selected="">Balikpapan</option>
                                            <option value="" selected="">Bandung</option>
                                            <option value="" selected="">Banten</option>
                                        </select>
                                    </div>
                                    <label class="col-auto text-right fs-11">Kwitansi</label>
                                    <div class="col-md-2">
                                        <input type="text" id="tx-tgl-dr" placeholder="yyyy-mm-dd" autocomplete="off" name="" class="form-control  form-control-sm  mb-2" tabindex="6">
                                    </div>
                                    <label class="col-auto text-right fs-11">s/d</label>
                                    <div class="col-md-2">
                                        <input type="text" id="tx-tgl-sd"  placeholder="yyyy-mm-dd" autocomplete="off" name="" class="form-control  form-control-sm  mb-2" tabindex="7">
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <select name="" id="" class="form-select form-control  form-control-sm  mb-2" tabindex="8">
                                            <option value="">Periode Setor</option>
                                            <option value="">Periode Transaksi</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive" id="tbl">
                                    ...
                                    <div class="table-responsive-sm" id="tbl">
                                        <table class="table table-striped card-table fs-10 p-1" width="100%">
                                            <thead>
                                              <tr class="border-top fs-11">
                                                <td class="py-2 w-1 p-1">Sah</td>
                                                <td class="py-2 w-9 p-1">Tgl Setor</td>
                                                <td class="py-2 w-9 p-1">Tgl Trs</td>
                                                <td class="py-2 w-9 p-1">Tgl Input</td>
                                                <td class="py-2 w-7 p-1">NoKwitansi</td>
                                                <td class="py-2 w-7 p-1">Kd.Jurnal</td>
                                                <td class="py-2 w-7 p-1">Nama Wakif</td>
                                                <td class="py-2 w-7 p-1">Pendaftar</td>
                                                <td class="py-2 w-10 p-1">Alamat</td>
                                                <td class="py-2 w-7 p-1">Hp</td>
                                                <td class="py-2 w-5 p-1">Email</td>
                                                <td class="py-2 w-5 p-1">Dana</td>
                                                <td class="py-2 w-9 p-1"></td>
                                              </tr>
                                            </thead>
                                            <tbody id='tbl-body'>
                                                <tr role="row" class="odd">
                                                    <td class="p-1"><i class="fa fa-fw fa-check"></i></td>
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-06-19</td>
                                                    <td class="p-1">2021-08-30 09:48</td>
                                                    <td class="p-1">MID_MDR_web_39172</td>
                                                    <td class="p-1">RV2006013923</td>
                                                    <td class="p-1">Zulkhairi Heri</td>
                                                    <td class="p-1">Zulkhairi Heri</td>
                                                    <td class="p-1">Apartemen gateway Pesanggrahan Tower B Lt 16 No.17 Petukangan Selatan pesanggrahan</td>
                                                    <td class="p-1">085658289185</td>
                                                    <td class="p-1">zulkhairi.heri@gmail.com</td>
                                                    <td class="angka p-1">11.650</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                    </td>
                                                </tr>
                                                <tr role="row" class="even">
                                                    <td class="p-1"><i class="fa fa-fw fa-check"></i></td>
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-13</td>
                                                    <td class="p-1">2020-11-13 09:18</td>
                                                    <td class="p-1">MID_GOP_web_45705</td>
                                                    <td class="p-1">RV2101027406</td>
                                                    <td class="p-1">Zulkhairi Heri</td>
                                                    <td class="p-1">Zulkhairi Heri</td>
                                                    <td class="p-1">Apartemen gateway Pesanggrahan Tower B Lt 16 No.17 Petukangan Selatan pesanggrahan</td>
                                                    <td class="p-1">085658289185</td>
                                                    <td class="p-1">zulkhairi.heri@gmail.com</td>
                                                    <td class="angka p-1">11.156</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-13</td>
                                                    <td class="p-1">2021-02-15 23:32</td>
                                                    <td class="p-1">MID_GOP_web_45786</td>
                                                    <td class="p-1">RV2101026799</td>
                                                    <td class="p-1">Rinda Ayu Nurani</td>
                                                    <td class="p-1">Rinda Ayu Nurani</td>
                                                    <td class="p-1"></td>
                                                    <td class="p-1">081326099393</td>
                                                    <td class="p-1">ndapandarinda@gmail.com</td>
                                                    <td class="angka p-1">11.732</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="even">
                                                    <td class="p-1"><i class="fa fa-fw fa-check"></i></td>
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-14</td>
                                                    <td class="p-1">2020-11-18 10:41</td>
                                                    <td class="p-1">MID_GOP_web_45811</td>
                                                    <td class="p-1">RV2101027407</td>
                                                    <td class="p-1">Yusuf</td>
                                                    <td class="p-1">Yusuf</td>
                                                    <td class="p-1"></td>
                                                    <td class="p-1">081318765056</td>
                                                    <td class="p-1">yusuf.seto@gmail.com</td>
                                                    <td class="angka p-1">110.243</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="p-1"><i class="fa fa-fw fa-check"></i></td>
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-15</td>
                                                    <td class="p-1">2021-02-24 16:33</td>
                                                    <td class="p-1">MID_GOP_web_45819</td>
                                                    <td class="p-1">RV2101026942</td>
                                                    <td class="p-1">Enda</td>
                                                    <td class="p-1">Enda</td>
                                                    <td class="p-1"></td>
                                                    <td class="p-1">081272561974</td>
                                                    <td class="p-1">enda1615@gmail.com</td>
                                                    <td class="angka p-1">11.750</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="even">
                                                    <td class="p-1"><i class="fa fa-fw fa-check"></i></td>
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-16</td>
                                                    <td class="p-1">2021-02-24 15:09</td>
                                                    <td class="p-1">MID_GOP_web_45844</td>
                                                    <td class="p-1">RV2101026789</td>
                                                    <td class="p-1">M Firman Karim,H.</td>
                                                    <td class="p-1">M Firman Karim, H.</td>
                                                    <td class="p-1"></td>
                                                    <td class="p-1">08888146799</td>
                                                    <td class="p-1">firmanul2016@yahoo.co.id</td>
                                                    <td class="angka p-1">115.275</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-16</td>
                                                    <td class="p-1">2021-02-24 15:49</td>
                                                    <td class="p-1">MID_GOP_web_45860</td>
                                                    <td class="p-1">RV2101026800</td>
                                                    <td class="p-1">Heru Binawan</td>
                                                    <td class="p-1">Heru Binawan</td>
                                                    <td class="p-1">Jl. Krukut Raya, Perum Pelangi Matoa No A3, Krukut, Limo</td>
                                                    <td class="p-1">08128003779</td>
                                                    <td class="p-1">herubinawan65@gmail.com</td>
                                                    <td class="angka p-1">11.660</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
                                                ...
                                                <tr role="row" class="even">
                                                    ...
                                                    <td class="p-1">2021-01-22</td>
                                                    <td class="sorting_1 p-1">2020-11-16</td>
                                                    <td class="p-1">2021-02-15 23:31</td>
                                                    <td class="p-1">MID_GOP_web_45870</td>
                                                    <td class="p-1">RV2101026801</td>
                                                    <td class="p-1">Indri</td>
                                                    <td class="p-1">Indri</td>
                                                    <td class="p-1"></td>
                                                    <td class="p-1">081297997752</td>
                                                    <td class="p-1">indriana.d@sbm-itb.ac.id</td>
                                                    <td class="angka p-1">120.170</td>
                                                    <td class="p-1">
                                                        <a href="#" data-id="MID_MDR_web_39172" class="editBtn"><i class="fe fe-edit text-success"></i>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="updateWakifNameList"><i class="fe fe-upload-cloud text-primary"></i></a>&nbsp;&nbsp;
                                                        <a href="#" data-id="MID_MDR_web_39172" class="delete"><i class="fe fe-x-circle text-danger"></i></a>
