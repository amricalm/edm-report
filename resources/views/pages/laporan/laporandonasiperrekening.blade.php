                        ...
                        <div class="card mb-4">
                            <div class="card-body py-4">
                                <div class="form-group row row-sm mb-0 align-items-center">
                                    <label class="col-md-1 fs-11">Kantor</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row row-sm mb-0 align-items-center">
                                    ...
                                    <label class="col-md-1 fs-11">Jenis</label>
                                    <div class="col-md-2">
...
$(function() {
    ...
    $(document).on('click', '.halaman', function(){
        ...
        loadData(page,tglDr,tglSd,cabang,program,jenisPeriode);
    });
    ...
    $('#tampil').click(function () {
        ...
        var program = $('#program').val();
        var jenisPeriode = $('#jenis-periode').val();
        loadData(1,tglDr,tglSd,cabang,program,jenisPeriode);
    });

    $(document).on("click", "#xlsExport", function()
    {
        let query = buildQuery({
        action: "{{route('lap.donasiPerRekening.xls')}}",
        url: {
                tglDr: $('#tx-tgl-dr').val(),
                tglSd: $('#tx-tgl-sd').val(),
                kdCabang: $('#cabang').val(),
...
function loadData(page,tglDr,tglSd,cabang,program,jenisPeriode){
    $.ajax({
        url:"{{ route('lap.getDonasiPerRekening.tbl') }}",
        method:"POST",
        data:{page:page,tglDr:tglDr,tglSd:tglSd,kdCabang:cabang,
            kdProgram:program,jenisPeriode:jenisPeriode},
